...
{
    public abstract class MyCollegeTaskWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyCollegeTaskWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyCollegeTaskWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyCollegeTaskDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyCollegeTaskDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyCollegeTaskDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyCollegeTaskDbContext, Task<T>> func)
        {
            T result;
